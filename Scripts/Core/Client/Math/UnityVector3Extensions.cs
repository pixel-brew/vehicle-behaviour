...
namespace Core
{
    public static class UnityVector3Extensions
    {
        ...
        public static float AngleRad(Vector3 from, Vector3 to)
        {
            ...
            return (float) (Mathf.Acos(Mathf.Clamp(Vector3.Dot(@from, to) / num, -1f, 1f)));
        }
        ...
        public static Vector2 GetXZ(this Vector3 current)
        {
            return new Vector2(current.x, current.z);
        }
        
        public static Vector2 GetXY(this Vector3 current)
        {
            return new Vector2(current.x, current.y);
        }
        public static Vector3 SetY(this Vector3 current, float y)
        {
