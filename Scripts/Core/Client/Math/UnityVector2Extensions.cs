...
namespace Core
{
    ...
    {
        public static Vector3 ToVector3(this Vector2 current)
        {
            return new Vector3(current.x, current.y, 0f);
        }
        ...
        public static Vector2 ProjectionOn(this Vector2 vector, Vector2 onNormal)
        {
        ...
        public static float AngleRad(Vector2 from, Vector2 to)
        {
            ...
            return (float) (Mathf.Acos(Mathf.Clamp(Vector2.Dot(@from, to) / num, -1f, 1f)));
        }
